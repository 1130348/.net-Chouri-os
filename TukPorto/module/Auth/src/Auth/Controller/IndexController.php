			...
			$form->setData($request->getPost());
			 if ($form->isValid()) {
				...
				$authAdapter = new AuthAdapter($dbAdapter,
										   'turistas', // there is a method setTableName to do the same
										   'nome', // there is a method setIdentityColumn to do the same
										   'passw', // there is a method setCredentialColumn to do the same
